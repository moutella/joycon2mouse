...
# Right now, the button masks and the joystick data is tailored towards the RightCon2. When we get ProCon2 data, i'll swap these out and ProCon2 will work.
BUTTON_MASKS = {
    0x000800: vg.XUSB_BUTTON.XUSB_GAMEPAD_A, # good
    0x000400: vg.XUSB_BUTTON.XUSB_GAMEPAD_B, # B
    0x000200: vg.XUSB_BUTTON.XUSB_GAMEPAD_X,
    0x000100: vg.XUSB_BUTTON.XUSB_GAMEPAD_Y, # Y
